...
export default function RowPeripherals({ peripheral, index }) {
  const { handlerRemovePeripherals } = usePeripherals();
    ...
    <tr key={index}>
      ...
      <td className="px-4 py-4 text-sm whitespace-nowrap">
        <div className="flex items-center gap-x-6">
          <NavLink
            to={`/inventory/perifericos/editar/${peripheral.id}`}
          ...
          <button
            ...
            onClick={() => handlerRemovePeripherals(peripheral.id)}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
