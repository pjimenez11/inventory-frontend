                ...
                <div className="flex flex-col  items-center w-full">
                    <form className="flex flex-col w-full px-6"> 
                        <div className="grid grid-cols-1 gap-6 mt-4 ">
                            <div>
                                <label className="text-blue-300 dark:text-gray-200 text-lg" htmlFor="product">Producto</label>
                            ...
                            <div>
                                <label className="text-blue-300 dark:text-gray-200 text-lg" htmlFor="laboratory">Laboratorio</label>
                            ...
                            <div>
                                <label className="text-blue-300 dark:text-gray-200 text-lg" htmlFor="custodian">Custodio</label>
                                <input id="custodian" type="password" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                            </div>

                            <div>
                                <label className="text-blue-300 dark:text-gray-200 text-lg" htmlFor="description">Descripción</label>
