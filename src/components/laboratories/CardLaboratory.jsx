  ...
  return (
    <div className="flex flex-col gap-2 bg-oxford-blue-900 rounded-lg p-5 shadow-xl hover:shadow-2xl transition-all transform hover:scale-105">
      ...
      <div className="flex flex-row justify-between">
        <div className="flex flex-row items-center justify-center gap-1 text-green-500 border border-green-500 rounded-lg px-3 py-1">
          <HiOutlineDesktopComputer />
          <h3 className="">{laboratory.computers}</h3>
        </div>
        <button className="border border-red-500 hover:bg-red-500 hover:border-red-600 hover:text-white rounded-lg px-3 py-1 text-red-500">
          Editar
        </button>
      </div>
    </div>
